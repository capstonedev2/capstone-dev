...
import { ResearchHeadChartCard } from '@/components/research-head/research-head-chart-card';
...
import {
  ...
  TOOLTIP_STYLE,
  YEAR_LABELS
} from '@/components/research-head/research-head-dashboard-data';
...
export function ResearchHeadDashboard() {
      ...
      >
        <div className="admin-page-stack">
          <section className="dashboard-command-panel" aria-label="Research head operational snapshot" style={{ background: 'linear-gradient(135deg, #003A8F, #1A1851)', color: 'white', borderRadius: '1.5rem', padding: '2.5rem', boxShadow: '0 20px 40px rgba(0, 58, 143, 0.15)', position: 'relative', overflow: 'hidden', display: 'flex', gap: '2rem', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            <div className="dashboard-command-aside" style={{ position: 'relative', zIndex: 1, flex: '1 1 300px', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
              <div className="dashboard-command-actions" aria-label="Primary dashboard actions" style={{ display: 'flex', gap: '1rem' }}>
                ...
                <Link className="btn" href="/research-head/approvals" style={{ flex: 1, background: 'rgba(255,255,255,0.1)', color: 'white', border: '1px solid rgba(255,255,255,0.2)', padding: '0.75rem', borderRadius: '0.75rem', fontWeight: 800, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem', backdropFilter: 'blur(10px)', textDecoration: 'none' }}>
          ...
          <section className="dashboard-analytics-grid dashboard-analytics-grid-top">
            <ResearchHeadChartCard badge={scopeLabel} description="Current project mix by lifecycle stage for the selected dashboard scope." title="Project Status Overview">
            ...
            </ResearchHeadChartCard>

            <ResearchHeadChartCard badge={formatAcademicYear(yearFilter)} description="Monthly submission, approval, and completion movement for the selected academic year." title="Monthly Submission and Completion Trend">
          ...
          <section className="dashboard-analytics-grid">
            <ResearchHeadChartCard badge={`${DEPARTMENTS.length} departments`} description="Compare volume, completions, and success rate across academic departments." title="Department Performance Comparison">
              <div className="dashboard-chart-frame dashboard-chart-frame-large">
                <ChartResponsiveContainer width="100%" height="100%">
            ...
            <ResearchHeadChartCard badge={`${adviserLoadData.length} advisers shown`} description="Current adviser supervision load based on projects under active research head monitoring." title="Adviser Load Distribution">
              <div className="dashboard-chart-frame dashboard-chart-frame-large">
                <ChartResponsiveContainer width="100%" height="100%">
          ...
          <section className="dashboard-control-grid">
            <ResearchHeadChartCard badge={`${scopeLabel} | ${formatAcademicYear(yearFilter)}`} className="dashboard-control-card" description="Adjust the reporting scope, generate official outputs, and jump directly to high-frequency administrative actions." title="Dashboard Controls">
              <div className="dashboard-control-layout">
                ...
                <div className="dashboard-quick-actions">
                  <Link className="btn btn-outline" href="/research-head/reports"><i className="fas fa-chart-bar"></i> Open Reports</Link>
                  <Link className="btn btn-outline" href="/research-head/projects"><i className="fas fa-folder-open"></i> Project Inventory</Link>
                  <Link className="btn btn-outline" href="/research-head/announcements"><i className="fas fa-bullhorn"></i> Announcements</Link>
                  <Link className="btn btn-outline" href="/research-head/approvals"><i className="fas fa-list-check"></i> Approval Queue</Link>
                </div>
              </div>
            </ResearchHeadChartCard>

            <ResearchHeadChartCard badge={`${pendingApprovals} pending`} description="Compact view of queue outcomes currently passing through the approval workflow." title="Approval Queue Analytics">
