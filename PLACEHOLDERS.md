...
| Portal status (maintenance mode, academic year, student registration, last branding update) | `portalStatus` | System settings and branding (`SystemSetting` rows, e.g. `system.themeBranding` `updatedAt`) |
